...
interface NewDonorOfferAllocationModalProps {
  onClose: () => void;
  donorOfferItemRequestId: string;
  title: string;
  type: string;
...
export default function NewDonorOfferAllocationModal({
  onClose,
...
}: NewDonorOfferAllocationModalProps) {
  ...
  function handleConfirm() {
    ...
    formData.append("donorOfferItemRequestId", donorOfferItemRequestId);
